package com.spiringai.open_ai.rag;
...
public class RandomDataLoader {
    ...
    /***
     * before executing the bean of RandomDataLoaderClass it will execute this method
     * or another way we can create job or script to load data into vector store
     */
    @PostConstruct
    public void loadSentencesIntoVectorStore() {
        ...
        /**
          * The Sentences are converted into Document objects and added to the vector store.
         *  The Documents form the spring AI vector store.
         */
