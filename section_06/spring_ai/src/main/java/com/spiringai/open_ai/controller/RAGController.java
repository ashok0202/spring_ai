...
public class RAGController {
    ...
    public ResponseEntity<String> randomChat(@RequestHeader("username") String username,
        ...
        /**
         * When we are using the RetrievalAugmentationAdvisor advisor bean that handle the retrieval of the documents
         * from the vector store and add it to the prompt.
         */
